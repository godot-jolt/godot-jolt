...
public:
	...
	enum Param {
		...
		PARAM_SWING_MOTOR_TARGET_VELOCITY_Y = JoltPhysicsServer3DExtension::CONE_TWIST_JOINT_SWING_MOTOR_TARGET_VELOCITY_Y,
		PARAM_SWING_MOTOR_TARGET_VELOCITY_Z = JoltPhysicsServer3DExtension::CONE_TWIST_JOINT_SWING_MOTOR_TARGET_VELOCITY_Z,
		PARAM_TWIST_MOTOR_TARGET_VELOCITY = JoltPhysicsServer3DExtension::CONE_TWIST_JOINT_TWIST_MOTOR_TARGET_VELOCITY,
		PARAM_SWING_MOTOR_MAX_TORQUE = JoltPhysicsServer3DExtension::CONE_TWIST_JOINT_SWING_MOTOR_MAX_TORQUE,
		PARAM_TWIST_MOTOR_MAX_TORQUE = JoltPhysicsServer3DExtension::CONE_TWIST_JOINT_TWIST_MOTOR_MAX_TORQUE
	};

	enum Flag {
		FLAG_USE_SWING_LIMIT = JoltPhysicsServer3DExtension::CONE_TWIST_JOINT_FLAG_USE_SWING_LIMIT,
		FLAG_USE_TWIST_LIMIT = JoltPhysicsServer3DExtension::CONE_TWIST_JOINT_FLAG_USE_TWIST_LIMIT,
		FLAG_ENABLE_SWING_MOTOR = JoltPhysicsServer3DExtension::CONE_TWIST_JOINT_FLAG_ENABLE_SWING_MOTOR,
		FLAG_ENABLE_TWIST_MOTOR = JoltPhysicsServer3DExtension::CONE_TWIST_JOINT_FLAG_ENABLE_TWIST_MOTOR
	};
