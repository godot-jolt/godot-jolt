...
public:
	...
	enum Param {
		...
		PARAM_LIMIT_SPRING_FREQUENCY = JoltPhysicsServer3DExtension::HINGE_JOINT_LIMIT_SPRING_FREQUENCY,
		PARAM_LIMIT_SPRING_DAMPING = JoltPhysicsServer3DExtension::HINGE_JOINT_LIMIT_SPRING_DAMPING,
		PARAM_MOTOR_TARGET_VELOCITY = PhysicsServer3D::HINGE_JOINT_MOTOR_TARGET_VELOCITY,
		PARAM_MOTOR_MAX_TORQUE = JoltPhysicsServer3DExtension::HINGE_JOINT_MOTOR_MAX_TORQUE
	};

	enum Flag {
		FLAG_USE_LIMIT = PhysicsServer3D::HINGE_JOINT_FLAG_USE_LIMIT,
		FLAG_USE_LIMIT_SPRING = JoltPhysicsServer3DExtension::HINGE_JOINT_FLAG_USE_LIMIT_SPRING,
