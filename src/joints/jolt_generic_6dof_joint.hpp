...
public:
	...
	enum Param {
		...
		PARAM_LINEAR_LIMIT_SPRING_FREQUENCY = JoltPhysicsServer3DExtension::G6DOF_JOINT_LINEAR_LIMIT_SPRING_FREQUENCY,
		PARAM_LINEAR_LIMIT_SPRING_DAMPING = JoltPhysicsServer3DExtension::G6DOF_JOINT_LINEAR_LIMIT_SPRING_DAMPING,
		...
		PARAM_LINEAR_SPRING_FREQUENCY = JoltPhysicsServer3DExtension::G6DOF_JOINT_LINEAR_SPRING_FREQUENCY,
		PARAM_LINEAR_SPRING_DAMPING = JoltPhysicsServer3DExtension::G6DOF_JOINT_LINEAR_SPRING_DAMPING,
		PARAM_LINEAR_SPRING_EQUILIBRIUM_POINT = JoltPhysicsServer3DExtension::G6DOF_JOINT_LINEAR_SPRING_EQUILIBRIUM_POINT,
		...
		PARAM_ANGULAR_SPRING_FREQUENCY = JoltPhysicsServer3DExtension::G6DOF_JOINT_ANGULAR_SPRING_FREQUENCY,
		PARAM_ANGULAR_SPRING_DAMPING = JoltPhysicsServer3DExtension::G6DOF_JOINT_ANGULAR_SPRING_DAMPING,
		PARAM_ANGULAR_SPRING_EQUILIBRIUM_POINT = JoltPhysicsServer3DExtension::G6DOF_JOINT_ANGULAR_SPRING_EQUILIBRIUM_POINT,
		PARAM_LINEAR_SPRING_MAX_FORCE = JoltPhysicsServer3DExtension::G6DOF_JOINT_LINEAR_SPRING_MAX_FORCE,
		PARAM_ANGULAR_SPRING_MAX_TORQUE = JoltPhysicsServer3DExtension::G6DOF_JOINT_ANGULAR_SPRING_MAX_TORQUE,
	};

	enum Flag {
		FLAG_ENABLE_LINEAR_LIMIT = PhysicsServer3D::G6DOF_JOINT_FLAG_ENABLE_LINEAR_LIMIT,
		FLAG_ENABLE_LINEAR_LIMIT_SPRING = JoltPhysicsServer3DExtension::G6DOF_JOINT_FLAG_ENABLE_LINEAR_LIMIT_SPRING,
		FLAG_ENABLE_LINEAR_MOTOR = PhysicsServer3D::G6DOF_JOINT_FLAG_ENABLE_LINEAR_MOTOR,
		FLAG_ENABLE_LINEAR_SPRING = JoltPhysicsServer3DExtension::G6DOF_JOINT_FLAG_ENABLE_LINEAR_SPRING,
		...
		FLAG_ENABLE_ANGULAR_SPRING = JoltPhysicsServer3DExtension::G6DOF_JOINT_FLAG_ENABLE_ANGULAR_SPRING,
		...
		FLAG_ENABLE_LINEAR_SPRING_FREQUENCY = JoltPhysicsServer3DExtension::G6DOF_JOINT_FLAG_ENABLE_LINEAR_SPRING_FREQUENCY,
		FLAG_ENABLE_ANGULAR_SPRING_FREQUENCY = JoltPhysicsServer3DExtension::G6DOF_JOINT_FLAG_ENABLE_ANGULAR_SPRING_FREQUENCY
	};
