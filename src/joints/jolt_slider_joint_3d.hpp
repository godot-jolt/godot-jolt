...
public:
	...
	enum Param {
		...
		PARAM_LIMIT_SPRING_FREQUENCY = JoltPhysicsServer3DExtension::SLIDER_JOINT_LIMIT_SPRING_FREQUENCY,
		PARAM_LIMIT_SPRING_DAMPING = JoltPhysicsServer3DExtension::SLIDER_JOINT_LIMIT_SPRING_DAMPING,
		PARAM_MOTOR_TARGET_VELOCITY = JoltPhysicsServer3DExtension::SLIDER_JOINT_MOTOR_TARGET_VELOCITY,
		PARAM_MOTOR_MAX_FORCE = JoltPhysicsServer3DExtension::SLIDER_JOINT_MOTOR_MAX_FORCE
	};

	enum Flag {
		FLAG_USE_LIMIT = JoltPhysicsServer3DExtension::SLIDER_JOINT_FLAG_USE_LIMIT,
		FLAG_USE_LIMIT_SPRING = JoltPhysicsServer3DExtension::SLIDER_JOINT_FLAG_USE_LIMIT_SPRING,
		FLAG_ENABLE_MOTOR = JoltPhysicsServer3DExtension::SLIDER_JOINT_FLAG_ENABLE_MOTOR,
	};
