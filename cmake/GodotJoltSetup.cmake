...
if(NOT DEFINED GJ_TARGET_ARCHITECTURES)
	if(CMAKE_HOST_SYSTEM_NAME STREQUAL Darwin)
		set(GJ_TARGET_ARCHITECTURES ${CMAKE_OSX_ARCHITECTURES})
	elseif(CMAKE_SYSTEM_PROCESSOR MATCHES [[^(i386|i686|x86)$]])
		set(GJ_TARGET_ARCHITECTURES x86)
	elseif(CMAKE_SYSTEM_PROCESSOR MATCHES [[^(AMD64|amd64|x86_64)$]])
		set(GJ_TARGET_ARCHITECTURES x64)
	else()
...
if(DEFINED ENV{VSCMD_ARG_TGT_ARCH})
	if(NOT $ENV{VSCMD_ARG_TGT_ARCH} STREQUAL ${GJ_TARGET_ARCHITECTURES})
		message(FATAL_ERROR
			...
			"'${GJ_TARGET_ARCHITECTURES}' architecture.\nPlease make sure you launch the "
...
macro(is_targeting instruction_sets output_variable)
	if(GJ_X86_INSTRUCTION_SET MATCHES "^(${instruction_sets})$")
...
is_targeting(AVX512 GJ_USE_AVX512)
is_targeting(AVX512|AVX2 GJ_USE_AVX2)
is_targeting(AVX512|AVX2 GJ_USE_BMI1)
is_targeting(AVX512|AVX2 GJ_USE_FMA3)
is_targeting(AVX512|AVX2 GJ_USE_F16C)
is_targeting(AVX512|AVX2|AVX GJ_USE_AVX)
is_targeting(AVX512|AVX2|AVX GJ_USE_SSE4_2)
is_targeting(AVX512|AVX2|AVX|SSE2 GJ_USE_SSE2)
