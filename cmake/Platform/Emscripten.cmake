# This is a copy of the cmake toolchain file shipped with Emscripten, but with the following changes:
# - The `TARGET_SUPPORTS_SHARED_LIBS` property is set to `TRUE` to allow the use of shared libraries.
# - The `SHARED_LIBRARY_CREATE_C_FLAGS` and `SHARED_LIBRARY_CREATE_CXX_FLAGS` properties are set to `-sSIDE_MODULE=1` to
#	instruct Emscripten to build a "side module," which is a shared library consumed by a "main module," which is Godot
#	in this case. More info here: https://emscripten.org/docs/compiling/Dynamic-Linking.html
# - The `SHARED_LIBRARY_SUFFIX` property is set to `.wasm` to match what Godot uses for side modules.
# - The various if ("${VAR}" STREQUAL "") checks are updated to use the `DEFINED` keyword to reflect new cmake behavior.
